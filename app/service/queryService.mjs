...
function queryService() {
    ...
    // const arg2p = common.tuprolog.arg2p.default()
    ...
    function solve(theoryText, queryText, flagsText, outputConsumer) {
        ...
        const { i, query } = tryBlock(() => common.tuprolog.bridge.solve(queryText, theoryText, flagsText, outputConsumer), "Solve Error");
        return { i, query };
    }
